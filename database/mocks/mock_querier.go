...
//
//	mockgen -source=database/sqlc/querier.go -destination=database/mocks/mock_querier.go -package=dbmocks
//
...
func (m *MockQuerier) GetCategory(ctx context.Context, id int32) (sqlc.Category, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetCurrency(ctx context.Context, id int16) (sqlc.Currency, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) GetTransactionType(ctx context.Context, id int16) (sqlc.TransactionType, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransactionType", ctx, id)
	ret0, _ := ret[0].(sqlc.TransactionType)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockQuerier) ListCurrencies(ctx context.Context) ([]sqlc.Currency, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) ListTransactionTypes(ctx context.Context) ([]sqlc.TransactionType, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) UpdateAccountBalance(ctx context.Context, arg sqlc.UpdateAccountBalanceParams) (sqlc.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockQuerier) UpdateCategory(ctx context.Context, arg sqlc.UpdateCategoryParams) (sqlc.Category, error) {
	m.ctrl.T.Helper()
